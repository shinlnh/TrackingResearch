...
$outputDir = Join-Path $repoRoot "OtherTracker\lasot\lasot936\HDT"
$resultsDir = Join-Path $outputDir "tracking_results\HDT"
...
results_dir = pathlib.Path("OtherTracker/lasot/lasot936/HDT/tracking_results/HDT")
...
tracker = SimpleNamespace(
    ...
    run_id=None,
    display_name="HDT",
    results_dir=str(repo / "OtherTracker" / "lasot" / "lasot936" / "HDT" / "tracking_results" / "HDT"),
)

report_name = "lasot_headtail40_hdt_othertracker"
...
summary_path = repo / "OtherTracker" / "lasot" / "lasot936" / "HDT" / "summary.csv"
