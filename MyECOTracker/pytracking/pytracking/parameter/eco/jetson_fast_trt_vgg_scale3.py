from pytracking.parameter.eco.jetson_fast_trt_vgg import parameters as base_parameters
import torch
...
def parameters():
    ...
    params.features.features[0].engine_path = 'resnet18_vggmconv1/resnet18_vggmconv1_otb_small_b3_fp16.engine'
    return params
