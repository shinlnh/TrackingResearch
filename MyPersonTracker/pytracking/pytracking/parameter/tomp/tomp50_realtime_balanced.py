...
def parameters():
    ...
    # Keep more accuracy than fast_cls_only profile, but target realtime with light frame skipping.
    ...
    # Skip one frame out of every 8 for a small FPS bump.
    params.cheap_frame_interval = 8
