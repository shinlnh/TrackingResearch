...
def resnet18(output_layers=None, pretrained=False, **kwargs):
    ...
    if pretrained:
        if 'resnet18' in model_urls:
            model.load_state_dict(model_zoo.load_url(model_urls['resnet18']))
        else:
            from torchvision.models import resnet18 as tv_resnet18, ResNet18_Weights
            model.load_state_dict(tv_resnet18(weights=ResNet18_Weights.IMAGENET1K_V1).state_dict())
    return model
...
def resnet50(output_layers=None, pretrained=False, **kwargs):
    ...
    if pretrained:
        if 'resnet50' in model_urls:
            model.load_state_dict(model_zoo.load_url(model_urls['resnet50']))
        else:
            from torchvision.models import resnet50 as tv_resnet50, ResNet50_Weights
            model.load_state_dict(tv_resnet50(weights=ResNet50_Weights.IMAGENET1K_V1).state_dict())
    return model
...
def resnet101(output_layers=None, pretrained=False, **kwargs):
    ...
    if pretrained:
        if 'resnet101' in model_urls:
            model.load_state_dict(model_zoo.load_url(model_urls['resnet101']))
        else:
            from torchvision.models import resnet101 as tv_resnet101, ResNet101_Weights
            model.load_state_dict(tv_resnet101(weights=ResNet101_Weights.IMAGENET1K_V1).state_dict())
    return model
