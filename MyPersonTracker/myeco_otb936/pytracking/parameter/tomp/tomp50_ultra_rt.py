...
def parameters():
    ...
    # Aggressive speed profile for realtime inference.
    params.train_feature_size = 14
    ...
    params.train_skipping = 50

    # Biggest speed lever: disable online classifier update.
    params.update_classifier = False
    params.fast_cls_only = True
    ...
    # Simpler localization branch for lower overhead.
