...
% -------------------------------------------------------------------------
include_dir = fullfile(matlabroot, 'toolbox', 'parallel', 'gpu', 'extern', 'include');
if ~exist(include_dir, 'dir')
  include_dir = fullfile(matlabroot, 'toolbox', 'distcomp', 'gpu', 'extern', 'include');
end

% -------------------------------------------------------------------------
function config_dir = matlab_gpu_mex_config_dir(arch)
% -------------------------------------------------------------------------
config_dir = fullfile(matlabroot, 'toolbox', 'parallel', 'gpu', 'extern', 'src', 'mex', arch);
if ~exist(config_dir, 'dir')
  config_dir = fullfile(matlabroot, 'toolbox', 'distcomp', 'gpu', 'extern', 'src', 'mex', arch);
end
