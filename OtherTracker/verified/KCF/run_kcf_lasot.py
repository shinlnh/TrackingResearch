...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run OpenCV KCF on LaSOT and save results under OtherTracker/lasot.")
    ...
    parser.add_argument("--output-dir", type=Path, help="Output directory. Defaults under OtherTracker/lasot/lasot936/KCF.")
    parser.add_argument("--display-name", default="KCF")
    parser.add_argument("--tracker-name", default="kcf")
    ...
    if output_dir is None:
        output_dir = REPO_ROOT / "OtherTracker" / "lasot" / "lasot936" / "KCF"
