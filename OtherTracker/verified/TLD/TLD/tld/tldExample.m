...
% if resize_ratio > 1
%     source.im0.input = imresize(source.im0.input, resize_ratio);
%     source.im0.blur = imresize(source.im0.blur, resize_ratio);
% end
...
%     if resize_ratio > 1
%         tld.img{i}.input = imresize(tld.img{i}.input, resize_ratio);
%         tld.img{i}.blur = imresize(tld.img{i}.blur, resize_ratio);
%     end
