...
%     fprintf('\ttraining batch %3d of %3d ... ', t, opts.maxiter) ;
    ...
    for h=1:opts.batchAcc_hnm
        ...
        res = vl_simplenn_compat(net, batch, [], res, ...
            'disableDropout', true, ...
...
%----------------------------yb added---------------------------    
    ...
    res_asdn=vl_simplenn_compat(net_asdn,batch_asdn,[],res_asdn,...
            'disableDropout', true, ...
            'conserveMemory', opts.conserveMemory, ...
            'sync', opts.sync);
...
%---------------------------------------------------------------         
    ...
    res = vl_simplenn_compat(net, batch, one, res, ...
        'conserveMemory', opts.conserveMemory, ...
        'sync', opts.sync) ;
...
%%-------------------yb added----------------------
    ...
    for i=1:9
        ...
        res_test = vl_simplenn_compat(net_fc, batch, [], res_test, ...
            'disableDropout', true, ...
            'conserveMemory', true, ...
            'sync', true) ;
    ...
    res_asdn = vl_simplenn_compat(net_asdn, batch, one, res_asdn, ...
        'conserveMemory', opts.conserveMemory, ...
        'sync', opts.sync) ;
