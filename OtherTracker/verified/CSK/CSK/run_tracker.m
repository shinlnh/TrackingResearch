...
function rect_result = run_tracker(video_path, video)
...
[img_files, pos, target_sz, resize_image, ground_truth, video_path] = load_video_info(video_path, video);
...
rect_result = zeros(numel(img_files), 4);
...
if resize_image, positions = positions * 2; rect_result = rect_result * 2; end
end
