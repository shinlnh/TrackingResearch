function summary = run_lct_otb(otb_root, sequence_file, out_dir, start_index, end_index)
%RUN_LCT_OTB Benchmark LCT on OTB using the original MATLAB implementation.
...
if nargin < 3 || isempty(out_dir)
    out_dir = fullfile(repo_root, 'OtherTracker', 'LCT', 'otb100_fps');
end
