...
STRUCTSIAM_DIR = THIS_DIR.parent / "verified" / "StructSiam"
sys.path.insert(0, str(STRUCTSIAM_DIR))

from run_structsiam_lasot import build_tracker_graph, run_sequence
...
def main():
    ...
    ckpt_path = STRUCTSIAM_DIR / "ckpt" / "ckpt" / "model_epoch49.ckpt"
    bundle = build_tracker_graph(ckpt_path)
