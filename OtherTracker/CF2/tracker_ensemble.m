...
seq_name = cf2_sequence_name;
if isempty(seq_name)
    seq_name = 'sequence';
end
fprintf('[CF2] %s start frames=%d\n', seq_name, numel(img_files));
sequence_timer = tic;
...
for frame = 1:numel(img_files),
    ...
    if should_log
        ...
        fprintf('[CF2] %s frame %d/%d (%.1f%%) elapsed %.1fs avg_fps %.3f eta %.1fs\n', ...
