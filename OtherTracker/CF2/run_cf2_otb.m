function summary = run_cf2_otb(otb_root, sequence_file, out_dir, start_index, end_index)
%RUN_CF2_OTB Benchmark CF2 on OTB using the original MATLAB implementation.
...
if nargin < 3 || isempty(out_dir)
    out_dir = fullfile(repo_root, 'OtherTracker', 'CF2', 'otb100_fps');
end
