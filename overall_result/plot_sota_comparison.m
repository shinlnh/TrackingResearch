...
plot_summary_bars(lasot_data, colors, 'LaSOT head-tail-40 (40 sequences)', ...
                  fullfile(out_dir, 'lasot_headtail40_summary'));
plot_per_sequence_auc(lasot_data, colors, 'LaSOT head-tail-40', ...
                      fullfile(out_dir, 'lasot_headtail40_per_sequence_auc'));
plot_auc_fps_scatter(lasot_data, colors, 'LaSOT head-tail-40', ...
                     fullfile(out_dir, 'lasot_headtail40_auc_vs_fps'));

%% ===== OTB plots =====
fprintf('\n=== OTB-100 ===\n');
otb_data = load_all(otb_sources);
plot_summary_bars(otb_data, colors, 'OTB-100 (100 sequences)', ...
